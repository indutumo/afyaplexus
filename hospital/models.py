...
class Hospital(models.Model):
	...
	alternative_number = models.CharField(max_length=100,default="-")
	...
	mobile_pysical = models.CharField(max_length=100,default='Physical')
	county = models.CharField(max_length=100,null=True,blank=True)
	constituent = models.CharField(max_length=100,null=True,blank=True)
